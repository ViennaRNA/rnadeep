...
class DataFromInterimFile(Sequence):
    def __init__(self,batch_size,directory):
        self.y = np.load(os.path.join(directory,"structures.npy"),mmap_mode="r")
        self.x = np.load(os.path.join(directory,"sequences.npy"),mmap_mode="r")
        self.batch_size = batch_size
        self.on_epoch_end()
...
class DataSliceFromInterimFile(Sequence):
    def __init__(self,batch_size,directory,dataset_size):
        self.y = np.load(os.path.join(directory,"structures.npy"),mmap_mode="r")[0:dataset_size]
        self.x = np.load(os.path.join(directory,"sequences.npy"),mmap_mode="r")[0:dataset_size]
        self.batch_size = batch_size
        self.on_epoch_end()
